...
contract OnChainPixelNFT is ERC721, Ownable, IOnChainPixel {
    ...
    /// @notice Authorized minters (Router contract)
    ...
    /// @notice Mint a new pixel art NFT with default canvas size (public, requires payment)
    ...
    /// @notice Mint with custom canvas size (public, requires payment)
    ...
    /// @notice Mint to a specific address (Router only, no payment check)
    ...
    /// @notice Mint to a specific address with custom size (Router only)
        ...
        private 
    {
        ...
        // Mint ERC-721 to specified address
    ...
    /// @notice Grant or revoke minter role (for Router contract)
