...
library SSTORE2 {
    ...
    function write(bytes memory data) internal returns (address pointer) {
        ...
        // Creation code layout (12 bytes total):
        // PUSH2 size     [3 bytes: 0x61 + uint16]
        // DUP1           [1 byte:  0x80]
        // PUSH1 0x0c     [2 bytes: 0x60 0x0c]  (12 = creation code length)
        ...
        bytes memory creationCode = abi.encodePacked(
            ...
            hex"80"                 // DUP1
            hex"600c"               // PUSH1 0x0c (creation code = 12 bytes)
            hex"6000"               // PUSH1 0x00
            hex"39"                 // CODECOPY
            hex"6000"               // PUSH1 0x00
            hex"f3",                // RETURN
